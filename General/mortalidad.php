...
$query4= "SELECT sum(salida.cantidad_h) as hh, sum(salida.cantidad_m) as mm from salida, nave, lote where salida.motivo ='1' AND (salida.fecha_reg BETWEEN  '$fec_ini 00:00:00' AND  '$fecha_fin 23:59:59')";
