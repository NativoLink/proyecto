...
$query66= "SELECT granja.nombre as nn, sum(incubadora.huevos_encu) as ah , sum(incubadora.huevos_recha) as am from incubadora, nave, lote, postura, granja where incubadora.id_postura = postura.id_postura and postura.id_nave = nave.id_nave and nave.id_lote = lote.id_lote and lote.id_granja = granja.id_granja and granja.id_granja='".$rowgg['id_granja']."' AND (incubadora.fecha_reg BETWEEN  '$fec_ini 00:00:00' AND  '$fecha_fin 23:59:59')  ORDER BY granja.id_granja";
