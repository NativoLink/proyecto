...
$query66= "SELECT granja.nombre as nn,sum(cantidad) as am from nacimiento, incubadora, postura, nave, 
lote, granja WHERE nacimiento.id_incubadora= incubadora.id_incubadora 
and incubadora.id_postura= postura.id_postura and postura.id_nave= nave.id_nave 
and nave.id_lote= lote.id_lote and lote.id_granja = granja.id_granja  and granja.id_granja ='".$rowgg['id_granja']."' AND (compra.fecha_reg BETWEEN  '$fec_ini 00:00:00' AND  '$fecha_fin 23:59:59')  ORDER BY granja.id_granja";
