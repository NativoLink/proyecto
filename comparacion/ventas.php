...
$query66= "SELECT granja.nombre as nn, sum(salida.cantidad_h) as ah, sum(salida.cantidad_m) as am from salida, nave, lote, granja where salida.motivo = 2 and salida.id_nave = nave.id_nave and nave.id_lote = lote.id_lote and lote.id_granja = granja.id_granja and granja.id_granja='".$rowgg['id_granja']."' AND (salida.fecha_reg BETWEEN  '$fec_ini 00:00:00' AND  '$fecha_fin 23:59:59')  ORDER BY granja.id_granja";
