...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="#" class="tip-bottom">Form elements</a> <a href="#" class="current">Compra</a> </div>
  ...
  <div class="row-fluid">
    <div class="span12">
      <div class="widget-box">
        <div class="widget-title" style="background: #861081"> <span class="icon"> <i class="icon-money" style="color:white"></i> </span>
          <h5 style="color: white">Compra</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="#" method="get" class="form-horizontal" id="form_compra">
...
?>
        ...
        <label class="control-label">Fecha:</label>
            ...
            <a href="#" class="btn btn-success" onclick="CargarAjax_Form('registro/reg_compra.php','form_compra','GET');limpiar()">Guardar </a>
 ...
 <div class="container-fluid">
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        foreach($db->query('SELECT sum(cantidad_h) as totalh , sum(cantidad_m) as totalm, id_nave  FROM  compra group by id_nave') as $row) 
        {
