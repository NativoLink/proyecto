...
?>
           ...
           <a href="#" class="btn btn-success" onclick="CargarAjax_Form('registro/reg_nave.php','form_nave','GET');limpiar()">Guardar </a>
...
?>
             ...
             <tr class="odd gradeX">
                  ...
                  <td class="center">  <?php echo a_number_format($row['id_lote'],0, '.',",",3); ?> </td>
                  <td class="center">  <?php echo a_number_format($row['totalh'], 0, '.',",",3); ?> </td>
                  <td class="center">  <?php echo a_number_format($row['totalm'], 0, '.',",",3); ?> </td>
